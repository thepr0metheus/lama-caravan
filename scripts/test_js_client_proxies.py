...
PINS = [
    ...
    ("agent_fold_line",
     "st.setTopology({ ...st.topology, proxies: PROXIES, clients: [{ id: \"c1\", manual: true, agents: [{ id: \"a1\", name: \"hermes\" }] }] });",
    ...
    ("agent_fold_line_shows_only_what_is_set",
     "st.setTopology({ ...st.topology, proxies: [{ ...PROXIES[0], clientTimeoutSeconds: 1800 }, PROXIES[1]], clients: [{ id: \"c1\", manual: true, agents: [{ id: \"a1\", name: \"hermes\" }] }] });",
    ...
    ("agent_fold_pinned",
     "st.setTopology({ ...st.topology, proxies: PROXIES, clients: [{ id: \"c1\", manual: true, agents: [{ id: \"a1\", name: \"hermes\" }] }] }); cf.CARD_FOLD.pinned.add(\"agent:c1:a1\");",
    ...
    ("agent_fold_full_lane",
     "st.setTopology({ ...st.topology, proxies: PROXIES, clients: [{ id: \"c1\", manual: true, agents: [{ id: \"a1\", name: \"hermes\" }] }] }); cf.CARD_FOLD.densities = { clients: \"full\" };",
    ...
    ("agent_fold_cells_lane_does_not_touch_clients",
     "st.setTopology({ ...st.topology, proxies: PROXIES, clients: [{ id: \"c1\", manual: true, agents: [{ id: \"a1\", name: \"hermes\" }] }] }); cf.CARD_FOLD.densities = { cells: \"full\" };",
