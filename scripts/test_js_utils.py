...
PINS = [
    ...
    ("fmt_gb_pair_says_the_unit_once", '', '[m.fmtGbPair(14.1 * 2 ** 30, 20.3 * 2 ** 30), m.fmtGbPair(0, 0), m.fmtGbPair(150 * 2 ** 30, 200 * 2 ** 30)]',
     '["14.1 / 20.3 GB","0.00 / 0.00 GB","150 / 200 GB"]',
     "часть от целого одной мерой: единица названа один раз — на карточке ячейки строка иначе обрезалась (найдено живьём)"),
