...
PINS = [
    ...
    ("host_rows_merge",
     ...
     '[{"box-a":[{"t":1},{"t":2},{"t":3}],"box-b":[{"t":7}]},{"box-a":[{"t":700}]},{}]',
     "строки машин доливаются по каждой своей: повтор не дублируется, новая машина приходит вся; держатся 10 минут по её собственным часам"),
    ("hosts_held",
     '',
     '[m.hostsHeld({ "box-a": [{ t: 1 }, { t: 1002 }], "box-b": [{ t: 5 }], "box-c": [] }), m.hostsHeld(null)]',
     '["box-a:1002,box-b:5",""]',
