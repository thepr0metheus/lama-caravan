...
PINS = [
    ...
    ("row_client_labels_not_read", 'st.ui.latestSystemMonitor = { clientLabels: { "10.0.0.7": "lab-box" } };',
     'await (async () => { await load([ROW()]); const h = wrap().innerHTML; st.ui.latestSystemMonitor = null; return [h.includes("<b>hermes</b><span class=\\"history-sub\\">10.0.0.7</span>"), h.includes("lab-box")]; })()',
