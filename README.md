...
| caravan-scout | 2.3.0 on the Linux host (2026-09-24) — installed with `./install.sh` and added from the board (Model servers → ＋ Add scout); knows its machine only, touches only the processes it started and the files it downloaded, and reads a model in place where it has the controller's file |
