...
export const numericFields = [
  ...
  "TIMEOUT", "THREADS_HTTP", "CACHE_REUSE", "IMAGE_MIN_TOKENS",
...
export const advancedGroups = [
  { titleKey: "advancedGeneration", fields: ["N_PREDICT", "KEEP", "ENABLE_THINKING"] },
  ...
  { titleKey: "advancedGpu", fields: ["KV_OFFLOAD", "MMAP", "NUMA", "DEVICE", "SPLIT_MODE", "TENSOR_SPLIT", "MAIN_GPU", "FIT", "FIT_TARGET", "FIT_CTX"] },
  { titleKey: "advancedServer", fields: ["ALIAS", "API_PREFIX", "TIMEOUT", "THREADS_HTTP", "CACHE_PROMPT", "CACHE_REUSE", "ENABLE_PROPS", "ENABLE_SLOTS"] },
  { titleKey: "advancedVision", fields: ["IMAGE_MIN_TOKENS", "IMAGE_MAX_TOKENS"] },
  { titleKey: "advancedReasoning", fields: ["REASONING", "REASONING_FORMAT", "REASONING_BUDGET", "CHAT_TEMPLATE", "CHAT_TEMPLATE_KWARGS", "SKIP_CHAT_PARSING"] },
...
export const advancedTabDefs = [
  ...
  { key: "tabServer",    groups: ["advancedEmbeddings", "advancedServer", "advancedVision", "advancedReasoning", "advancedTools"] },
];
