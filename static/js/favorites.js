...
export function renderFavoriteMirror(field, pfx = "") {
  ...
  const dragHandle = `<button class="fav-drag-handle" type="button" draggable="true" title="${escapeHtml(t("fvTitleDragReorder"))}" aria-label="${escapeHtml(t("fvTitleDragReorder"))}">⠿</button>`;
